...
const PAGES = [
  {
    ...
    sentences: [
"1990년대 들어 한국 정부가 피해 신고를 공식 접수한 사실이 확인됐다.",
"일본 정부는 강제 동원 사실을 부인하며 법적 책임을 회피한 것으로 나타났다.",
"일부 정치 지도자들은 사과 발언을 번복하거나 부정적인 태도를 보이기도 했다.",
"학계 일각에서는 피해자를 매춘부로 규정하는 왜곡이 발견돼 큰 논란이 일었다.",
"피해자들은 존엄 회복을 위해 다양한 자리에서 증언을 이어가고 있다.",
"그러나 이미 많은 피해자들은 고령에 이르러 현 세대의 관심과 지원이 절실한 상황이다.",
"이를 위해 국내뿐만 아니라 일본의 역사 단체들도 역사적 왜곡을 중단하기 위한 노력을 이어가고 있다.",
"국제 사회에서도 사죄와 배상 요구가 지속적으로 제기되고 있음에도 불구하고,",
"일본 정부의 공식적이고 진정성 있는 사과는 끝내 이루어지지 않았다."
    ],
    distort: { index: 6, text: "피해자들이 이미 보상과 합의를 통해 문제를 해결했다." } // 7번째 왜곡
  },
  // {
